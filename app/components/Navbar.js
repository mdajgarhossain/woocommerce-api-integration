...
//                     Shop
//                 </Link>
//                 <Link href="/my-account" className="text-white text-lg">
//                     My Account
//                 </Link>
...
//                 <Link href="/cart" className="text-white text-lg flex items-center mr-4">
//                     <FaShoppingCart className="mr-2" />
//                     <span>{cartItems.length}</span>
//                 </Link>
//                 {user ? (
...
//         }, 3000); // Delay to ensure smooth transition
//     };
