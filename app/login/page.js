    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
                <div className={`bg-white p-8 rounded-lg shadow-lg w-full max-w-md ${isLoggingIn ? 'opacity-50' : ''}`}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className={`w-full py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${isLoggingIn ? 'opacity-50' : ''}`}
                            disabled={isLoggingIn}
                        >
                            {isLoggingIn && (
                                <svg
